...
| [**Portfolio**](https://lucaspaiva-lp.vercel.app) | `Next.js` `TypeScript` `Tailwind` `GraphQL` | Personal engineering dashboard featuring real-time GitHub contribution tracking and automated deployment pipeline. | [Repository](https://github.com/lucaspaiva-lp/my-website) |

...
| :--- | :--- | :--- | :--- |
| <a href="https://fivelib.vercel.app" target="_blank" rel="noopener noreferrer">**Fivelib**</a> | `FastAPI` `Pydantic` `Next.js` `TypeScript` `PostgreSQL` | Centralized platform for technical academic documentation, featuring user libraries, private link management, and custom support ticket infrastructure. | [Repository](https://github.com/fivelibx/fivelib) |
